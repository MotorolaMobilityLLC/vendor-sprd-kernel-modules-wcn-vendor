...
#define ENG_BT_NEW_ADDRESS_REQ ("MAC?")
#define ENG_BT_NEW_ADDRESS ("MAC")
...
typedef enum {
    ...
    /* NEW ADDRESS */
    BT_ADDRESS_NEW_REQ_INDEX,
    BT_ADDRESS_NEW_INDEX,
...
#define BT_ADDRESS_NEW_REQ_RET ("+SPBTTEST:MAC=")
