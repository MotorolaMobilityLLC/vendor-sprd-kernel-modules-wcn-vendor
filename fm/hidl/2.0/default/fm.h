...
#define FM_IOCTL_GET_CUR_BLER_CMD       _IOWR(FM_IOC_MAGIC, 0x4C, int32_t*)
...
#define FM_IOCTL_SOFT_MUTE_TUNE _IOWR(FM_IOC_MAGIC, 63, fm_softmute_tune_t*)/*for soft mute tune*/
...
#define FM_IOCTL_RW_REG        _IOWR(FM_IOC_MAGIC, 12, struct fm_reg_ctl_parm*)

//IOCTL for set region
